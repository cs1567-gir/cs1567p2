...
color_mask_list = numpy.array([240,200,170,  238,235,225, 192,227,245, 175,163,150, 180, 165, 240], dtype=numpy.uint8, order='C')
robots = []
top_buffer = []
mid_buffer = []
threshold = 22
...
def top_image_callback(message):
    ...
    if message.encoding == "bgr8": #this is image_color encoding
        ...
        _libmask_array.color_mask(message.data, top_mask.width * top_mask.height, color_mask_list, 5, threshold, top_buffer, 60)
...
def update_robots(locations, blobs, offset):
    ...
    #    offset_x = locations[0][0]
    #    offset_y = locations[0][1]
    #    locations.pop(0) # get rid of offset
